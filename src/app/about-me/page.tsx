    ...
    <>
      <Container customStyles='mx-auto mb-0 mt-5 max-w-7xl px-2 sm:mt-20 sm:px-6 lg:px-8'>
        ...
        <div>
          ...
          <img
            src='https://github-widgetbox.vercel.app/api/profile?username=DennohKim&data=followers,repositories,stars,commits&theme=nautilus'
            alt='github stats'
          ...
          <div className='my-5 flex flex-col items-center justify-between gap-5 sm:mx-36 sm:gap-0 lg:flex-row  '>
            <img
              src='https://github-readme-stats.vercel.app/api?username=DennohKim&show_icons=true&theme=transparent'
              alt='github stats'
              className='mb-5 sm:mb-0'
            />
            {/* Top Language */}
            <img
              src='https://github-readme-stats.vercel.app/api/top-langs/?username=DennohKim&theme=transparent&layout=compact'
              alt='github stats'
            />
          </div>
          <div className='mt-8 flex flex-col items-center justify-between gap-5 sm:mx-36 sm:mt-14 sm:gap-0 lg:flex-row'>
            ...
            <a href='https://wakatime.com/@chizaa'>
              <img
        ...
        <div className='mx-auto my-10 w-full items-center justify-center'>
          ...
          <a href='https://data-card-for-spotify.herokuapp.com/card?user_id=dennohkim'>
            <img
              src='https://data-card-for-spotify.herokuapp.com/api/card?user_id=dennohkim'
